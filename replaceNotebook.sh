...
export SERVER_FULLNAME="${1:-testing.db.faims.edu.au}" # dev, alpha, testing, selenium
...
python3.10 faims3-temp-notebook-migrator/loadNotebook.py --project_key "campus_survey_demo" --notebook_json "notebook.json"  --env-file=secret.json
